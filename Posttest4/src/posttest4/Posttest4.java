...
public static abstract class Authentication {
 ...
 public static class User extends Authentication {
...
//Class Provinsi
    public static class Provinsi extends Negara{
        ...
        @Override
        public void Display(){
            //Semua Display memiliki fitur Overloading
            super.Display();
    ...
    public static class Kota extends Ibukota{
        int Jumlah_Kota;
    ...
    if (posisi >= 1 && posisi <= DaftarNegara.size()) {
        ...
        if (negara instanceof Provinsi provinsi) {
            ...
            kota.Nama_Ibukota=((Ibukota)negara).Nama_Ibukota;
